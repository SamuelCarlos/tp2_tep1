...
@param PokemonList* poke_list: a list whit various pokemons;
*/
...
@param Pokemon* poke: a struct pointer with the pokemon data(destiny);
@param Pokemon* poke2: a struct pointer with the pokemon data (origin);
...
@param PokemonList* poke_list: a list whit various pokemons;
@param int position: the position of the pokemon in the list;
...
@param PokemonLista* cell: a cell of list(destiny);
@param Pokemon* pokemon: a struct pointer with the pokemon data (origin);
...
@param int *quantity: pointer to save the amount of pokemons read ;
...
@param Pokemon* pokemon: a struct pointer with the pokemon data;
@param float new_hp: the new pokemon hp;
*/
