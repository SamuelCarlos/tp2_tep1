 ...
 * @param attack: Attack struct pointer ;
 */
 ...
 * @param  attackquantity: pointer to save the amount of attacks read ;
 ...
 * @param attacks: attack struct pointer to pointer ;
 * @param attacksQuantity: total number of attacks (used in the for) ;
 */
 ...
 * @param  A: the attack value of the attacking pokemon;
 * @param  D: the defense value of the defending pokemon;
 * @param  is_MT: checks if the attack is of the same type as the pokemon;
 ...
 * @param attack: the attack number of dispatch table;
 * @param attacker: struct that contains all the data of the pokemon that is attacking ;
 * @param deffender: struct that contains all the data of the pokemon that is defending ;
 * @param attacker_debuffs: debuff list of the attacking pokemon ;
 * @param deffender_debuffs: debuff list of the defending pokemon ;
 * @param type_relation: the type relation between the two pokemon;
 */
 ...
 * @param debuff_list: a debuff list null or with the debuffs of pokemon ;
 ...
 * @param debuff_list: a debuff list with the debuffs of pokemon ;
 */
 ...
 * @param type: number that corresponds to the debuff type;
 * @param debuff_list: a debuff or with the debuffs of pokemon ;
 ...
 * @param list: a debuff list with the debuffs of pokemon;
 */
 ...
 * @param conditions: array containing pokemon debuff conditions (between 0 and 7);
 * @param pokemon: struct that contains all the data of the pokemon;
 * @param debuff_list: a debuff list with the debuffs of pokemon;
 */
 ...
 * @param conditions: array containing pokemon debuff conditions (between 0 and 7);
 * @param pokemon: struct pointer that contains all the data of the pokemon;
 * @param is_removing: checks if the debuff needs to be removed;
 */
